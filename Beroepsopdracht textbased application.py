...
while True:
    ...
    def choice8():
        ...
        if choice8a == "a":
            ...
            print("You proceed the journey on your own, but later decide its better to go and find Emir again.")
            choice19()
        else:
    ...
    #choice16,
    def choice16():
        print("The two of you quickly get into the back of truck, but by doing so you expose the group to the men, causing them to all get captured.")
        ending1()
    ...
    #choice18,
    def choice18():
        print("Im over here!, You hear Emir scream.\n You run over towards Emir, but stop quickly.\n Emir is being held captive by a man with a knife.\n He threatens to kill Emir if you move closer.\n \n A= Attempt to rescue Emir.\n B= Surrender.\n")
        choice18a = input()
        if choice18a == "a":
            choice20()
        elif choice18a == "b":
            ...
            print("please use the given choices\n")
            choice18()

    #choice19.
    def choice19():
        print("You follow the path you think Emir made, but are not sure.\n You have found many other people fleeing the country, but not Emir.\n Suddenly, you hear something.")
        choice18()

    #choice20.
    def choice20():
        print("You jump onto the man and succesfully take the knife away from the man.\n Unfortunately, the man now has a pistol in his hands.\n \n A= Surrender.\n B= Sign to Emir to attack the man at the same time.\n")
        choice20a = input()
        if choice20a == "a":
            choice22()
        elif choice20a == "b":
            ...
            print("Please choose one of the given anwsers.")
            choice20()

    #choice21.
    def choice21():
        print("You put your hands behind your head, and get captured.")
        ending1()

    #choice22.
    def choice22():
        print("You Signal Emir, and start to countdown.\n At three, you both jump the man.\n You succesfully defeat the man and Go on with your journey.")
        ending4()

    #choice23.
    def choice23():
        print("You surrender, but the man has had enough of you.")
        ending3()

    #ending1.
    def ending1():
        print("\n You get thrown into a truck, together with other captured people.\n You get taken to a prison camp.")
        reboot1()

    #ending2.
    def ending2():
        print("\n You are acorss the border, but your journey is far from over.\n You are free to go wherever you want to.")
        reboot1()

    #ending3.
    def ending3():
        print("\n You and Emir both get shot by the man.\n Your life flashes in front of you as you feel yourself slowly loosing concious.\n You slowly bleed to death.")
        reboot1()

    #ending4.
    def ending4():
        print("\n You and Emir succesfully make it across the border.\n You decide to find temporary shelter.\n A few days later, You and Emir start the journey towards The Netherlands.\n After months and months of traveling, you and Emir have safely made it to the Netherlands, now living in a shelter for refugees.")
        reboot1()
